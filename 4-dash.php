...
if($product === "original") {
  $price = $number * 0.039 + 0.097;
}
else {
  $price = $number * 0.057 + 0.097;
}
?>
<div class="middle">
<h1>send <?php echo $price;?> DASH to <b>Xe3S5MfYf16KSbt8n7rb7JDXZs9n19FgYh</b></h1>

<br>
<br>
<img src="https://chart.googleapis.com/chart?chs=300&300&cht=qr&chl=Xe3S5MfYf16KSbt8n7rb7JDXZs9n19FgYh&choe=UTF-8" style="width:200px;">  
<br>
<hr>
<br>
...
<p>if you don't give <?php echo $price; ?> bitcoin to <b>Xe3S5MfYf16KSbt8n7rb7JDXZs9n19FgYh</b> you can't get candle</p>
