...
if($product === "original") {
  $price = $number * 0.00027 + 0.00067;
}
else {
  $price = $number * 0.00041 + 0.00067;
}
?>
<div class="middle">
<h1>send <?php echo $price;?> Bitcoin to <b>36PVPkguFysBbVjwkEruXhKG3H5LmshpSm</b></h1>

<br>
<br>
<img src="https://chart.googleapis.com/chart?chs=300&300&cht=qr&chl=36PVPkguFysBbVjwkEruXhKG3H5LmshpSm&choe=UTF-8" style="width:200px;">  
<br>
<hr>
<br>
...
<p>if you don't give <?php echo $price; ?> bitcoin to <b>36PVPkguFysBbVjwkEruXhKG3H5LmshpSm</b> you can't get candle</p>
